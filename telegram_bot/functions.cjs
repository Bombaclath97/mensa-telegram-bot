...
var isMemberRegistered = function (id) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, fetch("http://".concat(process.env.CRUD_ENDPOINT, "/members/").concat(id)).then(function (res) {
    ...
    return __generator(this, function (_a) {
        ...
        transporter.sendMail(mailOpts, function (error, info) {
            if (error) {
                ...
                console.log("Sent email to ".concat(to, ". Info: ").concat(info));
            }
        });
        return [2 /*return*/];
    });
